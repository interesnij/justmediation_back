    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mediator', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='events', to='users.Mediator')),
                ('timezone', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='events', to='users.TimeZone')),
            ],
            options={
                'verbose_name': 'Event',
