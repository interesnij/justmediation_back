...
router.register(
    ...
    basename='mediator_specialities'
)
router.register(
    r'users/fee-types',
    views.FeeKindViewSet,
    basename='mediator_fee_types'
)
router.register(
    r'users/law-firms',
    views.LawFirmViewSet,
    basename='mediator_law_firms'
)
router.register(
    r'users/mediators/universities',
    views.MediatorUniversityViewSet,
    basename='mediator_institutions'
)
router.register(
    r'users/mediators/current',
    views.CurrentMediatorActionsViewSet,
    basename='current_mediator_actions'
)
router.register(
    r'users/appointment-types',
    views.AppointmentTypeViewSet,
    basename='mediator_appointment_types'
)
router.register(
    r'users/payment-types',
    views.PaymentTypeViewSet,
    basename='mediator_payment_types'
)
router.register(
    r'users/languages',
    views.LanguageViewSet,
    basename='mediator_languages'
)
router.register(
    r'users/currencies',
    views.CurrenciesViewSet,
    basename='mediator_currencies'
)
router.register(
    r'users/timezones',
...
urlpatterns += [
    ...
    re_path(
        r'^users/mediators/current/$',
        views.CurrentMediatorView.as_view(),
